...
import co.apperto.fastqrreaderview.R;
...
public class FlutterCameraPreview extends ViewGroup {
    ...
    private static final String TAG = FlutterCameraPreview.class.getSimpleName();
    ...
    public FlutterCameraPreview(Context context, SurfaceTexture texture) {
        super(context);
        initialize(context, null, 0, 0, texture);
    }
