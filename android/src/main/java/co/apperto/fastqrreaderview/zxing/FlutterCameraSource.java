package co.apperto.fastqrreaderview.zxing;

/**
 * Created by goncalopalma on 30/01/2019
...
public class FlutterCameraSource {
...
//  private final GraphicOverlay graphicOverlay;
    ...
    public FlutterCameraSource(Activity activity) {
...
//    graphicOverlay.clear();
    ...
    public synchronized FlutterCameraSource start() throws IOException {
        if (camera != null) {
            return this;
        }
     ...
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public synchronized FlutterCameraSource start(SurfaceTexture surfaceHolder) throws IOException {
        if (camera != null) {
            return this;
        }
